...
function AttributeGridSearchParamType($compile, DynamicParamTypeService) {
  ...
  return {
    restrict: 'E',
    templateUrl: 'app/common/deepsense-components/deepsense-attributes-panel/attribute-types/attribute-gridsearch-param/attribute-gridsearch-param-type.html',
    replace: true,
    scope: true,
    link: (scope, element) => {
      let internal = {};
