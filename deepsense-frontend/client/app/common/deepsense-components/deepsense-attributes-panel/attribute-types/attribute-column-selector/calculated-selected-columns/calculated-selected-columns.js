...
function CalculatedSelectedColumns() {
  return {
    restrict: 'E',
    templateUrl: 'app/common/deepsense-components/deepsense-attributes-panel/attribute-types/attribute-column-selector/calculated-selected-columns/calculated-selected-columns.html',
    replace: true,
    scope: true,
