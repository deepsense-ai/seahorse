...
function IndexListSelectorItem($document, $timeout) {
  return {
    restrict: 'E',
    templateUrl: 'app/common/deepsense-components/deepsense-attributes-panel/attribute-types/attribute-column-selector/selector-items/index-list-selector-item.html',
    replace: true,
    scope: true,
