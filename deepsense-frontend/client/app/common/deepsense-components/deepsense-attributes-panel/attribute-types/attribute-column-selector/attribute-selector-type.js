...
function AttributeSelectorType($timeout, $uibModal, $rootScope) {
  return {
    restrict: 'E',
    templateUrl: 'app/common/deepsense-components/deepsense-attributes-panel/attribute-types/attribute-column-selector/attribute-selector-type.html',
    replace: true,
    scope: true,
      ...
      _.assign(scope, {
        ...
        openSelector() {
          ...
          this.modal = $uibModal.open({
            templateUrl: 'app/common/deepsense-components/deepsense-attributes-panel/attribute-types/attribute-column-selector/attribute-selector-type-modal.html',
