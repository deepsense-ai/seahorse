...
function OperationsCategory(RecursionHelper) {
  return {
    templateUrl: 'app/common/deepsense-components/deepsense-catalogue-panel/catalogue-panel-operations-category/catalogue-panel-operations-category.html',
    replace: true,
    scope: {
      search: '=',
      category: '=',
    ...
    controller: ['$scope', function($scope) {
      ...
      ocCtrl.templateUrl = 'app/common/deepsense-components/deepsense-catalogue-panel/catalogue-panel-operations-category/popoverTemplate.html';
