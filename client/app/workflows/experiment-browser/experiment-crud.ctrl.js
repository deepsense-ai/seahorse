...
class ExperimentCrudController {
  ...
  addExperiment() {
    ShowModal.call(
      this,
      'app/workflows/experiment-browser/experiment-crud-modal/experiment-crud-add-modify-modal/experiment-crud-add-modify-modal.tmpl.html',
  ...
  removeExperiment(experimentItem) {
    ShowModal.call(
      this,
      'app/workflows/experiment-browser/experiment-crud-modal/experiment-crud-delete-modal/experiment-crud-delete-modal.tmpl.html',
