...
import io.deepsense.entitystorage.{EntityStorageClient, EntityStorageClientTestInMemoryImpl}
import io.deepsense.graph.{Edge, Graph, Node}
import io.deepsense.graphexecutor.SimpleGraphExecutionIntegSuiteEntities
import io.deepsense.model.json.workflow.AbstractMetadataJsonProtocol
