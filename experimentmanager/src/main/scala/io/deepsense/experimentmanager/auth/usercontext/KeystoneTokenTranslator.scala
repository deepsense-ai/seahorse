...
package io.deepsense.experimentmanager.auth.usercontext
...
import org.jclouds.openstack.keystone.v2_0.domain.{Role => KeystoneRole, Token => KeystoneToken, User => KeystoneUser, Tenant => KeystoneTenant}
