...
class VectorIndexer extends EstimatorAsOperation[VectorIndexerEstimator] {
  ...
  override val description: String =
    "VectorIndexer helps index categorical features inside of a Vector." +
      "It decides which features are categorical and converts them to category indices. " +
      "Decision is based on the number of distinct values of a feature."
}
